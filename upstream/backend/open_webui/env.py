...
# How many days audit log files are retained by Loguru.
def parse_audit_log_retention_days(value: str | None) -> int:
    try:
...
AUDIT_LOG_RETENTION_DAYS = parse_audit_log_retention_days(os.getenv('AUDIT_LOG_RETENTION_DAYS'))
